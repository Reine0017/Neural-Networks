...
def main():
    ...
    for c,k in enumerate(list_case):
        ...
        for b,j in enumerate(list_model):
            ...
            logits = rnn_call(k,x, is_dropout, keep_prob, j)
    ...
    plt.figure(1)
    plt.plot(range(no_epochs), all_test_acc[0][0], label = 'rnn')
    plt.plot(range(no_epochs), all_test_acc[0][1], label = 'gru')
    plt.plot(range(no_epochs), all_test_acc[0][2], label = 'lstm')
    plt.legend(loc='lower right', title = 'model-type')
    plt.xlabel(str(no_epochs) + ' iterations')
    plt.ylabel('test accuracy')
    plt.title('test accuracy vs. epochs (rnn-char)')

    plt.figure(2)
    plt.plot(range(no_epochs), all_test_acc[1][0], label = 'rnn')
    plt.plot(range(no_epochs), all_test_acc[1][1], label = 'gru')
    plt.plot(range(no_epochs), all_test_acc[1][2], label = 'lstm')
    plt.legend(loc='lower right', title = 'model-type')
    plt.xlabel(str(no_epochs) + ' iterations')
    plt.ylabel('test accuracy')
    plt.title('test accuracy vs. epochs(rnn-word)')
